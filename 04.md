...
Pour la rédaction des algorithmes, nous allons utiliser du pseudo-code. C'est une manière simple poser sur papier des algorithmes afin d'expliciter leur fonctionnement.
